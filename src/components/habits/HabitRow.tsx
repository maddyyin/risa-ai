...
export function HabitRow({ habit, days, onToggle }: HabitRowProps) {
  ...
  // Calculate streak from completions: count consecutive days backwards from yesterday (or today if completed today)
  ...
  // Calculate completion percentage: completions in days list / total elapsed days in days list
